...
![Image](/2: Event loop and Concurrency/images/EventLoop.png)
...
![Image](/2: Event loop and Concurrency/images/CallStack.png)
...
![Image](/2: Event loop and Concurrency/images/CallStack2.png)
...
![Image](/2: Event loop and Concurrency/images/CallStack3.png)
...
![Image](/2: Event loop and Concurrency/images/CallStack4.png)
...
![Image](/2: Event loop and Concurrency/images/SlowOperations.png)
...
![Image](/2: Event loop and Concurrency/images/Callback.png)
...
![Image](/2: Event loop and Concurrency/images/Callback2.png)
...
![Image](/2: Event loop and Concurrency/images/Callback3.png)

<p>Và ngay sau đó <strong>console.log(8)</strong> được đẩy vào callstack</p>

![Image](/2: Event loop and Concurrency/images/Callback4.png)
...
![Image](/2: Event loop and Concurrency/images/Callback5.png)
...
![Image](/2: Event loop and Concurrency/images/Callback6.png)

<p>Sau đó setTimeout được đẩy vào với tham số đầu tiên là callback, tham số thứ 2 là 5 giây</p>

![Image](/2: Event loop and Concurrency/images/Callback7.png)
...
![Image](/2: Event loop and Concurrency/images/Callback8.png)
...
![Image](/2: Event loop and Concurrency/images/Callback9.png)
...
![Image](/2: Event loop and Concurrency/images/Callback10.png)

<p>Cuối cùng sau 5 giây, callback 1 và callback 2 sẽ được đẩy vào <strong>event queue</strong></p>

![Image](/2: Event loop and Concurrency/images/Callback11.png)
...
![Image](/2: Event loop and Concurrency/images/Callback12.png)
...
![Image](/2: Event loop and Concurrency/images/Callback13.png)
...
![Image](/2: Event loop and Concurrency/images/setImmediate.png)
